...
from logics.lots_bot import start_monitoring
...
class BotManager:
    ...
    def remove_user(self, item_id: int, user_id: int):
        self.user_map[item_id] = [u for u in self.user_map[item_id] if u.user_id != user_id]
